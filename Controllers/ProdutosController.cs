...
namespace ShopShop.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CategoriaId,PrecoCont,PrecoPD,PrecoMerc")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CategoriaId,PrecoCont,PrecoPD,PrecoMerc")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
